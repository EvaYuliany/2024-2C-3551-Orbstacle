...
public class SpherePrimitive : GeometricPrimitive {
  /// <summary>
  ///     Constructs a new sphere primitive, with the specified size,
  ///     tessellation level and white color.
  /// </summary>
  /// <param name="graphicsDevice">Used to initialize and control the
  /// presentation of the graphics device.</param> <param
  /// name="diameter">Diameter of the sphere.</param> <param
  /// name="tessellation">The number of times the surface triangles are
  /// subdivided.</param>
  public SpherePrimitive(GraphicsDevice graphicsDevice, float diameter = 1,
                         int tessellation = 16)
      : this(graphicsDevice, diameter, tessellation, Color.White) {}

  /// <summary>
  ///     Constructs a new sphere primitive, with the specified size,
  ///     tessellation level and color.
  /// </summary>
  /// <param name="graphicsDevice">Used to initialize and control the
  /// presentation of the graphics device.</param> <param
  /// name="diameter">Diameter of the sphere.</param> <param
  /// name="tessellation">The number of times the surface triangles are
  /// subdivided.</param> <param name="color">Color of the sphere.</param>
  public SpherePrimitive(GraphicsDevice graphicsDevice, float diameter,
                         int tessellation, Color color) {
    if (tessellation < 3)
